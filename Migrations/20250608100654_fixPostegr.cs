...
{
    /// <inheritdoc />
    public partial class fixPostegr : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2025, 6, 7, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(1870), "Processing", 0.00m, 5 },
                    { 2, false, new DateTime(2025, 6, 6, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(1880), "Completed", 0.00m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Inappropriate behavior.", new DateTime(2025, 6, 8, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(990), null, null, 2, 1, null, null, 0, 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Great pet!", new DateTime(2025, 6, 7, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1810), 2 },
                    { 2, 2, "Very playful.", new DateTime(2025, 6, 6, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1820), 3 },
                    { 3, 3, "Beautiful singing!", new DateTime(2025, 6, 5, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1820), 1 },
                    { 4, 1, "Very friendly dog!", new DateTime(2025, 6, 4, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1820), 8 },
                    { 5, 1, "Great pet!", new DateTime(2025, 6, 7, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1830), 5 },
                    { 6, 2, "Very playful.", new DateTime(2025, 6, 6, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1830), 5 },
                    { 7, 8, "Beautiful singing!", new DateTime(2025, 6, 5, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1830), 1 },
                    { 8, 6, "Very friendly dog!", new DateTime(2025, 6, 4, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1830), 3 },
                    { 9, 8, "Great pet!", new DateTime(2025, 6, 7, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1840), 5 },
                    { 10, 6, "Very playful.", new DateTime(2025, 6, 6, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1840), 2 },
                    { 11, 3, "Beautiful singing!", new DateTime(2025, 6, 5, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1840), 5 },
                    { 12, 9, "Very friendly dog!", new DateTime(2025, 6, 4, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1850), 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Great product! My dog loves it.", 1, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1460), 1 },
                    { 2, "Good value for the price.", 1, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1510), 2 },
                    { 3, "Excellent quality. Highly recommend.", 2, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1520), 3 },
                    { 4, "My cat is obsessed with this toy!", 3, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1520), 4 },
                    { 5, "Keeps my bird entertained for hours.", 5, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1560), 5 },
                    { 6, "This collar is so stylish and well-made.", 6, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 1 },
                    { 7, "Best litter I've ever used. Controls odor perfectly.", 7, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 2 },
                    { 8, "Affordable and effective.", 1, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 3 },
                    { 9, "A must-have for cat owners.", 7, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 4 },
                    { 10, "Highly recommend this brand.", 2, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 5 },
                    { 11, "My hamster loves this bedding!", 8, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1570), 1 },
                    { 12, "Great for small dogs, very durable.", 9, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1580), 2 },
                    { 13, "Excellent for training puppies.", 10, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 3 },
                    { 14, "My rabbit enjoys chewing on these sticks.", 11, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 4 },
                    { 15, "The fish food is top-notch, my fish are thriving.", 12, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 5 },
                    { 16, "This leash is very strong and comfortable.", 13, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 6 },
                    { 17, "The catnip spray is a big hit with my cats.", 14, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 7 },
                    { 18, "These treats are healthy and delicious.", 15, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1590), 8 },
                    { 19, "Perfect for my guinea pig's cage.", 16, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 9 },
                    { 20, "Keeps my aquarium clean and clear.", 17, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 6 },
                    { 21, "My dog sleeps so well on this bed.", 18, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 3 },
                    { 22, "Easy to use and effective flea treatment.", 19, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 6 },
                    { 23, "The birdseed mix is a great value.", 20, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 5 },
                    { 24, "My kitten loves this scratching post.", 21, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1600), 1 },
                    { 25, "This vitamin supplement has improved my pet's health.", 22, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 2 },
                    { 26, "Great for travel, very convenient.", 23, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 3 },
                    { 27, "My reptile enjoys basking under this lamp.", 24, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 4 },
                    { 28, "The dog shampoo smells amazing.", 25, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 5 },
                    { 29, "These chew toys are perfect for aggressive chewers.", 26, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 6 },
                    { 30, "My bird loves playing with this mirror.", 27, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1610), 7 },
                    { 31, "Excellent quality food, my dog is very happy.", 28, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 2 },
                    { 32, "This carrier is sturdy and comfortable.", 29, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 4 },
                    { 33, "The water fountain is a great addition to my cat's setup.", 30, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 3 },
                    { 34, "These training pads are very absorbent.", 1, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 4 },
                    { 35, "My hamster loves running in this wheel.", 2, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 6 },
                    { 36, "This harness is very easy to put on.", 3, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1620), 5 },
                    { 37, "The cat grass is a great natural treat.", 4, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1630), 1 },
                    { 38, "These dental chews have improved my dog's breath.", 5, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1630), 2 },
                    { 39, "My guinea pig loves hiding in this tunnel.", 6, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1630), 3 },
                    { 40, "The aquarium decorations are very realistic.", 7, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1630), 4 },
                    { 41, "This bird cage is spacious and easy to clean.", 8, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1630), 5 },
                    { 42, "My dog loves playing fetch with this frisbee.", 9, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1640), 6 },
                    { 43, "The cat tree is sturdy and provides plenty of scratching posts.", 10, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1640), 7 },
                    { 44, "This food bowl is perfect for my messy eater.", 11, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1640), 8 },
                    { 45, "The grooming brush is gentle and effective.", 12, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1640), 5 },
                    { 46, "My pet loves the taste of this toothpaste.", 13, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1640), 3 },
                    { 47, "This tick and flea collar is a lifesaver.", 14, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 4 },
                    { 48, "The travel carrier is lightweight and easy to carry.", 15, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 10 },
                    { 49, "This playpen is perfect for keeping my puppy contained.", 16, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 5 },
                    { 50, "The aquarium filter is quiet and efficient.", 17, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 1 },
                    { 51, "My cat loves lounging in this hammock.", 18, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 2 },
                    { 52, "This dog bed is super comfy and easy to wash.", 19, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1650), 3 },
                    { 53, "The bird perch is a great addition to my bird's cage.", 20, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 4 },
                    { 54, "This cat toy is interactive and keeps my cat entertained.", 21, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 5 },
                    { 55, "The dog treats are made with high-quality ingredients.", 22, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 6 },
                    { 56, "This pet carrier is perfect for air travel.", 23, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 7 },
                    { 57, "The reptile tank is well-ventilated and secure.", 24, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 8 },
                    { 58, "This dog coat is warm and waterproof.", 25, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1660), 9 },
                    { 59, "The chew toy is durable and long-lasting.", 26, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1670), 4 },
                    { 60, "This bird swing provides hours of fun for my feathered friend.", 27, new DateTime(2025, 6, 8, 13, 6, 53, 959, DateTimeKind.Local).AddTicks(1670), 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Animal listing seems suspicious.", new DateTime(2025, 6, 8, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(1000), 2, null, null, 2, null, null, 1, 1 },
                    { 3, "Product description is misleading.", new DateTime(2025, 6, 8, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(1000), null, 1, null, 1, "Issue addressed.", new DateTime(2025, 6, 8, 10, 6, 53, 959, DateTimeKind.Utc).AddTicks(1000), 2, 2 }
                });
