        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirthDayFormatted = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    animal_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemType = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "Animal"),
                    animal_new_price = table.Column<double>(type: "double precision", nullable: true),
                    animal_old_price = table.Column<double>(type: "double precision", nullable: true),
                    animal_title = table.Column<string>(type: "text", nullable: false),
                    animal_category = table.Column<string>(type: "text", nullable: true),
                    animal_description = table.Column<string>(type: "text", nullable: false),
                    animal_type = table.Column<string>(type: "text", nullable: false),
                    gender = table.Column<int>(type: "integer", nullable: true),
                    age = table.Column<string>(type: "text", nullable: false),
                    vaccineStatus = table.Column<string>(type: "text", nullable: true),
                    animal_weight = table.Column<double>(type: "double precision", nullable: true),
                    animal_size = table.Column<string>(type: "text", nullable: false),
                    health_status = table.Column<string>(type: "text", nullable: false),
                    animal_pic = table.Column<string>(type: "text", nullable: true),
                    userId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    IncludeDelivery = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    product_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemType = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "Product"),
                    product_title = table.Column<string>(type: "text", nullable: false),
                    product_new_price = table.Column<double>(type: "double precision", nullable: true),
                    product_old_price = table.Column<double>(type: "double precision", nullable: true),
                    ...
                    designedFor = table.Column<string>(type: "text", nullable: false),
                    product_pic = table.Column<string>(type: "text", nullable: true),
                    userId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnimalReviewId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedAnimalId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2025, 6, 7, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5700), "Processing", 0.00m, 5 },
                    { 2, false, new DateTime(2025, 6, 6, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5710), "Completed", 0.00m, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Product", "Dogs", new DateTime(2025, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "Complete and balanced nutrition for medium-sized dogs, ensuring they stay healthy and active.", 149.99000000000001, 174.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741953227/zltok0kmocaleqoemuys.jpg", "Medium", "Premium Dog Food", "Dog Food", 1.5, "Daily Nutrition", 1 },
                    { 2, "Product", "Cats", new DateTime(2026, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "Irresistible and nutritious food for cats, providing all essential vitamins and minerals.", 119.98999999999999, 139.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741960387/zix6312xkimurxwksjst.avif", "Small", "Delicious Cat Food", "Cat Food", 1.2, "Daily Nutrition", 1 },
                    { 3, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A tough and durable dog toy that can withstand rough play.", 79.989999999999995, 94.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955580/b7nmjo982o1dkaqtubku.jpg", "Medium", "Durable Dog Toy", "Dog Toy", 0.29999999999999999, "Playtime", 2 },
                    { 4, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "An interactive cat toy with a feather wand that keeps cats entertained.", 49.990000000000002, 59.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956365/gr7q1jkq8xogpqlx9o1o.jpg", "Small", "Interactive Cat Toy - Feather Wand", "Cat Toy", 0.10000000000000001, "Playtime", 3 },
                    { 5, "Product", "Birds", new DateTime(2025, 9, 20, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A balanced seed mix for various bird species, ensuring they get all necessary nutrients.", 59.990000000000002, 69.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957685/ibhil7hr2wt0ciy5zcyj.webp", "Small", "Nutritious Bird Food", "Bird Food", 0.5, "Daily Nutrition", 4 },
                    { 6, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A stylish and durable leather dog collar that is both comfortable and secure.", 89.989999999999995, 99.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954791/kobkb9gw1j2t72b6aatd.webp", "Medium", "Stylish Dog Collar", "Dog Collar", 0.20000000000000001, "Identification", 5 },
                    { 7, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "Clumping cat litter with odor control, making it easy to clean and maintain.", 179.99000000000001, 199.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954193/yu68n8ma6esrgufvtx33.webp", "Large", "Clumping Cat Litter", "Cat Litter", 5.0, "Hygiene", 1 },
                    { 8, "Product", "Fish", new DateTime(2024, 11, 15, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A complete and balanced flake food for tropical fish, promoting vibrant colors and health.", 39.990000000000002, 49.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955640/uobazeneyfmnq04jfa4l.avif", "Small", "Flake Fish Food", "Fish Food", 0.20000000000000001, "Daily Nutrition", 2 },
                    { 9, "Product", "Fish", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A decorative castle for your aquarium, providing a fun and engaging environment for fish.", 69.989999999999995, 84.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956401/lgwwur552kzaufiuoxxa.webp", "Small", "Aquarium Castle Decoration", "Fish Toy", 0.050000000000000003, "Decoration", 3 },
                    { 10, "Product", "Fish", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A 20-gallon glass fish tank, perfect for creating a beautiful and healthy aquatic environment.", 249.99000000000001, 299.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957720/xzf1pgalohpwa7azu7pe.jpg", "Medium", "20-Gallon Fish Tank", "Fish Tank", 10.0, "Housing", 4 },
                    { 11, "Product", "Rabbits", new DateTime(2025, 10, 10, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A nutritious blend of pellets and hay for rabbits, promoting healthy digestion and growth.", 29.989999999999998, 39.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954089/monptgbpqqzhorh2gfy6.webp", "Medium", "Healthy Rabbit Food", "Rabbit Food", 1.0, "Daily Nutrition", 1 },
                    { 12, "Product", "Birds", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A vibrant and engaging toy for birds, encouraging physical activity and mental stimulation.", 19.989999999999998, 29.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955686/xaiur3dmdjsvwsngnyii.jpg", "Small", "Colorful Bird Toy", "Bird Toy", 0.10000000000000001, "Playtime", 2 },
                    { 13, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A soft and comfortable bed for cats, providing a warm and secure place to rest.", 49.990000000000002, 59.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956435/o0uzedcounew68oukbu7.jpg", "Large", "Cozy Cat Bed", "Cat Bed", 2.0, "Comfort", 3 },
                    { 14, "Product", "Hamsters", new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A balanced mix of seeds and grains for hamsters, ensuring they get all essential nutrients.", 14.99, 19.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957787/fettuiqxovj57cmi0ppu.webp", "Small", "Nutritious Hamster Food", "Hamster Food", 0.5, "Daily Nutrition", 4 },
                    { 15, "Product", "Fish", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A realistic plant decoration for aquariums, providing a natural and engaging environment for fish.", 9.9900000000000002, 14.99, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955043/rcs8vtdc8urroayazj0w.webp", "Small", "Aquarium Plant Decoration", "Fish Toy", 0.050000000000000003, "Decoration", 5 },
                    { 16, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A strong and durable leash for dogs, perfect for daily walks and outdoor activities.", 24.989999999999998, 29.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954049/tezqcas06et9honx9y86.jpg", "Medium", "Durable Dog Leash", "Dog Leash", 0.29999999999999999, "Walking", 1 },
                    { 17, "Product", "Birds", new DateTime(2025, 9, 20, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A premium blend of organic seeds and grains for birds, promoting overall health and vitality.", 39.990000000000002, 49.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955725/nfzdycfvxveqfrvchj3z.webp", "Small", "Organic Bird Food", "Bird Food", 0.5, "Daily Nutrition", 2 },
                    { 18, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A fun and engaging catnip mouse toy for cats, encouraging play and exercise.", 9.9900000000000002, 14.99, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956472/ykvgrdxzmfaafbaoilue.avif", "Small", "Catnip Mouse Toy", "Cat Toy", 0.10000000000000001, "Playtime", 3 },
                    { 19, "Product", "Birds", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A large and spacious bird cage, providing a comfortable and secure home for birds.", 99.989999999999995, 129.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957870/n9e5bx66dikdf5fyfxcq.jpg", "Large", "Spacious Bird Cage", "Bird Cage", 5.0, "Housing", 4 },
                    { 20, "Product", "Fish", new DateTime(2024, 11, 15, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A high-quality flake food for tropical fish, promoting vibrant colors and overall health.", 19.989999999999998, 24.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954880/srawajwhg2hvdzfjonhb.jpg", "Small", "Premium Fish Food", "Fish Food", 0.20000000000000001, "Daily Nutrition", 5 },
                    { 21, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A fun and durable squeaky toy for dogs, perfect for playtime and keeping them entertained.", 14.99, 19.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741953866/psz0doiximrgborkzpw7.jpg", "Large", "Squeaky Dog Toy", "Dog Toy", 0.5, "Playtime", 1 },
                    { 22, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A sturdy and durable scratching post for cats, helping to keep their claws healthy and sharp.", 39.990000000000002, 49.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955790/qjlot9jgusogh3ojvouf.webp", "Medium", "Cat Scratching Post", "Cat Scratching Post", 3.0, "Scratching", 2 },
                    { 23, "Product", "Dogs", new DateTime(2025, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A nutritious and grain-free dog food, perfect for dogs with sensitive stomachs.", 59.990000000000002, 69.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956514/rguwh1ryedofnanavonv.png", "Large", "Grain-Free Dog Food", "Dog Food", 2.0, "Daily Nutrition", 3 },
                    { 24, "Product", "Birds", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A colorful and engaging hanging toy for birds, encouraging physical activity and mental stimulation.", 14.99, 19.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957904/xfihpgurbllxxt0lekns.webp", "Small", "Hanging Bird Toy", "Bird Toy", 0.10000000000000001, "Playtime", 4 },
                    { 25, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A comfortable and supportive orthopedic bed for dogs, providing a restful and relaxing sleep.", 79.989999999999995, 99.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956554/s7h2ba0rbo3ucft7kyby.jpg", "Large", "Orthopedic Dog Bed", "Dog Bed", 4.0, "Comfort", 5 },
                    { 26, "Product", "Cats", new DateTime(2026, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A nutritious and grain-free cat food, perfect for cats with sensitive stomachs.", 49.990000000000002, 59.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741954134/iluy4dlkwdx3mkynui9k.jpg", "Medium", "Grain-Free Cat Food", "Cat Food", 1.5, "Daily Nutrition", 1 },
                    { 27, "Product", "Fish", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A realistic shipwreck decoration for aquariums, providing a fun and engaging environment for fish.", 19.989999999999998, 24.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955891/tird6slrw64hjeogskki.jpg", "Small", "Aquarium Shipwreck Decoration", "Fish Toy", 0.050000000000000003, "Decoration", 2 },
                    { 28, "Product", "Birds", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "A natural and comfortable perch for birds, providing a secure place to rest and play.", 14.99, 19.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741956554/s7h2ba0rbo3ucft7kyby.jpg", "Medium", "Natural Bird Perch", "Bird Perch", 0.5, "Resting", 3 },
                    { 29, "Product", "Hamsters", new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "A premium blend of organic seeds and grains for hamsters, promoting overall health and vitality.", 19.989999999999998, 24.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741957961/sodo2bm6sbox45mpr5w1.webp", "Small", "Organic Hamster Food", "Hamster Food", 0.5, "Daily Nutrition", 4 },
                    { 30, "Product", "Dogs", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Toys", "A durable rope tug toy for dogs, perfect for interactive play and keeping them entertained.", 9.9900000000000002, 14.99, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741953866/psz0doiximrgborkzpw7.jpg", "Large", "Rope Tug Toy", "Dog Toy", 0.5, "Playtime", 5 },
                    { 101, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Housing", "SNOW PERS: Where Persian cats find warmth and love", 39.990000000000002, 59.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1743240140/losj6asybcmbi22urkmz.jpg", "Small", "SNOW PERS Cats shelte", "Litter Boxes", 3.0, "Shelter", 5 },
                    { 102, "Product", "Small Animals", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Other", "Ensure your pet's safety and comfort on every journey with our premium Pets Seat. Designed for small dogs and cats, this seat elevates your pet, giving them a clear view of the road while keeping them securely restrained. Features include a soft, plush interior, adjustable straps for secure attachment to your car seat, and durable, easy-to-clean materials", 79.989999999999995, 99.989999999999995, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1742192894/fzdr5qq81ugmmeckjghw.jpg", "Extra Large", "Pets Seat", "Other", 6.0, "Comfort", 6 },
                    { 103, "Product", "Dogs", new DateTime(2028, 7, 19, 0, 0, 0, 0, DateTimeKind.Utc), "Health", "Vaccinations are a crucial part of preventative care for dogs. They stimulate the immune system to protect against potentially life-threatening diseases such as rabies, distemper, parvovirus, and others. Consult your veterinarian to determine the appropriate vaccination schedule for your dog .", 34.990000000000002, 39.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1743241554/vhs6cteezhygcbznmk1m.webp", "Medium", "Dogs Vaccine", "Vaccines", 1.3, "Recovery", 5 },
                    { 104, "Product", "Horses", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Accessories", "Horse Gears fit to all horses types.", 39.990000000000002, 44.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1742429525/xrkg6frlfmlkanj8nck2.jpg", "Large", "Horse Gears", "Carriers", 2.0, "Handling", 7 },
                    { 105, "Product", "Horses", new DateTime(2028, 8, 18, 0, 0, 0, 0, DateTimeKind.Utc), "Food", "Elevate your horse’s health and performance with these premium Horse Supplements, specially formulated to support the vitality of your equine companion. Crafted from high-quality, natural ingredients, this blend is designed to enhance strength, stamina, and overall well-being. Whether your horse is a spirited Arabian racer or a gentle Quarter Horse, these supplements provide essential vitamins, minerals, and nutrients to promote strong bones, a glossy coat, and optimal muscle development.", 119.98999999999999, 139.99000000000001, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1742433963/vlsptmakxfbzytuzb37n.webp", "Extra Large", "Horse Suppliments", "Supplements", 5.0, "Daily Nutrition", 8 },
                    { 106, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Housing", "Safe, comfy, and convenient. Your pet's ideal travel companion", 19.989999999999998, 24.989999999999998, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1742193491/ujynvt9m3lmhmqmx30ag.jpg", "Medium", "Pets Rest Seat", "Beds", 1.0, "Resting", 9 },
                    { 107, "Product", "Cats", new DateTime(9999, 12, 31, 0, 0, 0, 0, DateTimeKind.Utc), "Housing", "A sturdy and durable scratching post for cats, helping to keep their claws healthy and sharp.", 39.990000000000002, 49.990000000000002, "https://res.cloudinary.com/dhbhh9aln/image/upload/v1741955790/qjlot9jgusogh3ojvouf.webp", "Medium", "Cat House Play", "Kennels", 2.0, "Climbing", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Inappropriate behavior.", new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(4990), null, null, 2, 1, null, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(4990), 0, 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Great pet!", new DateTime(2025, 6, 7, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5660), 2 },
                    { 2, 2, "Very playful.", new DateTime(2025, 6, 6, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5660), 3 },
                    { 3, 3, "Beautiful singing!", new DateTime(2025, 6, 5, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5660), 1 },
                    { 4, 1, "Very friendly dog!", new DateTime(2025, 6, 4, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 8 },
                    { 5, 1, "Great pet!", new DateTime(2025, 6, 7, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 5 },
                    { 6, 2, "Very playful.", new DateTime(2025, 6, 6, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 5 },
                    { 7, 8, "Beautiful singing!", new DateTime(2025, 6, 5, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 1 },
                    { 8, 6, "Very friendly dog!", new DateTime(2025, 6, 4, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 3 },
                    { 9, 8, "Great pet!", new DateTime(2025, 6, 7, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 5 },
                    { 10, 6, "Very playful.", new DateTime(2025, 6, 6, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5670), 2 },
                    { 11, 3, "Beautiful singing!", new DateTime(2025, 6, 5, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5680), 5 },
                    { 12, 9, "Very friendly dog!", new DateTime(2025, 6, 4, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5680), 7 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Great product! My dog loves it.", 1, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 1 },
                    { 2, "Good value for the price.", 1, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 2 },
                    { 3, "Excellent quality. Highly recommend.", 2, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 3 },
                    { 4, "My cat is obsessed with this toy!", 3, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 4 },
                    { 5, "Keeps my bird entertained for hours.", 5, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 5 },
                    { 6, "This collar is so stylish and well-made.", 6, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5460), 1 },
                    { 7, "Best litter I've ever used. Controls odor perfectly.", 7, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 2 },
                    { 8, "Affordable and effective.", 1, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 3 },
                    { 9, "A must-have for cat owners.", 7, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 4 },
                    { 10, "Highly recommend this brand.", 2, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 5 },
                    { 11, "My hamster loves this bedding!", 8, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 1 },
                    { 12, "Great for small dogs, very durable.", 9, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 2 },
                    { 13, "Excellent for training puppies.", 10, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 3 },
                    { 14, "My rabbit enjoys chewing on these sticks.", 11, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 4 },
                    { 15, "The fish food is top-notch, my fish are thriving.", 12, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 5 },
                    { 16, "This leash is very strong and comfortable.", 13, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 6 },
                    { 17, "The catnip spray is a big hit with my cats.", 14, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5470), 7 },
                    { 18, "These treats are healthy and delicious.", 15, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 8 },
                    { 19, "Perfect for my guinea pig's cage.", 16, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 9 },
                    { 20, "Keeps my aquarium clean and clear.", 17, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 6 },
                    { 21, "My dog sleeps so well on this bed.", 18, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 3 },
                    { 22, "Easy to use and effective flea treatment.", 19, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 6 },
                    { 23, "The birdseed mix is a great value.", 20, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 5 },
                    { 24, "My kitten loves this scratching post.", 21, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 1 },
                    { 25, "This vitamin supplement has improved my pet's health.", 22, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 2 },
                    { 26, "Great for travel, very convenient.", 23, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 3 },
                    { 27, "My reptile enjoys basking under this lamp.", 24, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 4 },
                    { 28, "The dog shampoo smells amazing.", 25, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5480), 5 },
                    { 29, "These chew toys are perfect for aggressive chewers.", 26, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 6 },
                    { 30, "My bird loves playing with this mirror.", 27, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 7 },
                    { 31, "Excellent quality food, my dog is very happy.", 28, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 2 },
                    { 32, "This carrier is sturdy and comfortable.", 29, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 4 },
                    { 33, "The water fountain is a great addition to my cat's setup.", 30, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 3 },
                    { 34, "These training pads are very absorbent.", 1, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 4 },
                    { 35, "My hamster loves running in this wheel.", 2, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 6 },
                    { 36, "This harness is very easy to put on.", 3, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 5 },
                    { 37, "The cat grass is a great natural treat.", 4, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 1 },
                    { 38, "These dental chews have improved my dog's breath.", 5, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 2 },
                    { 39, "My guinea pig loves hiding in this tunnel.", 6, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5490), 3 },
                    { 40, "The aquarium decorations are very realistic.", 7, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 4 },
                    { 41, "This bird cage is spacious and easy to clean.", 8, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 5 },
                    { 42, "My dog loves playing fetch with this frisbee.", 9, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 6 },
                    { 43, "The cat tree is sturdy and provides plenty of scratching posts.", 10, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 7 },
                    { 44, "This food bowl is perfect for my messy eater.", 11, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 8 },
                    { 45, "The grooming brush is gentle and effective.", 12, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 5 },
                    { 46, "My pet loves the taste of this toothpaste.", 13, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 3 },
                    { 47, "This tick and flea collar is a lifesaver.", 14, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 4 },
                    { 48, "The travel carrier is lightweight and easy to carry.", 15, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5500), 10 },
                    { 49, "This playpen is perfect for keeping my puppy contained.", 16, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 5 },
                    { 50, "The aquarium filter is quiet and efficient.", 17, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 1 },
                    { 51, "My cat loves lounging in this hammock.", 18, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 2 },
                    { 52, "This dog bed is super comfy and easy to wash.", 19, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 3 },
                    { 53, "The bird perch is a great addition to my bird's cage.", 20, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 4 },
                    { 54, "This cat toy is interactive and keeps my cat entertained.", 21, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 5 },
                    { 55, "The dog treats are made with high-quality ingredients.", 22, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 6 },
                    { 56, "This pet carrier is perfect for air travel.", 23, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 7 },
                    { 57, "The reptile tank is well-ventilated and secure.", 24, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 8 },
                    { 58, "This dog coat is warm and waterproof.", 25, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 9 },
                    { 59, "The chew toy is durable and long-lasting.", 26, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5510), 4 },
                    { 60, "This bird swing provides hours of fun for my feathered friend.", 27, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5520), 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Animal listing seems suspicious.", new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(4990), 2, null, null, 2, null, new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(4990), 1, 1 },
                    { 3, "Product description is misleading.", new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5000), null, 1, null, 1, "Issue addressed.", new DateTime(2025, 6, 8, 11, 9, 8, 208, DateTimeKind.Utc).AddTicks(5000), 2, 2 }
                });
